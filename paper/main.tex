...
top-$k$ problems, selecting on \emph{average precision} robustly beats selecting on the noisy
target metric itself --- across 93 datasets and three model families --- and the deciding
factor for how much any of this matters is a plain count, how many positives your budget will
contain, not a ratio of rates.
