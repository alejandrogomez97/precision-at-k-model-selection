...
(Section~\ref{sec:loss}). (ii) We show empirically, over 93 datasets and three model families, that precision@$k$ is
also a poor \emph{model-selection} metric: average precision selects
significantly better models on the very precision@$k$ objective, in every family
